...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/annotations', false);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bootstrapFb', 'user' => 'root', 'password' => 123456, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1f6dc09fa28d8da80de3636fcb24bc115f824b8d4b18d0f1d11c5c7d7af2e5bf');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1f6dc09fa28d8da80de3636fcb24bc115f824b8d4b18d0f1d11c5c7d7af2e5bf');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_1f6dc09fa28d8da80de3636fcb24bc115f824b8d4b18d0f1d11c5c7d7af2e5bf');
        ...
        $h->setProxyDir('/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/../web', false);
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5347b0aad5d81'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5347b0aad5d81'), 4 => new \FOS\FacebookBundle\Security\Authentication\Provider\FacebookProvider('public', $this->get('fos_facebook.api')), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5347b0aad5d81')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod',
            ...
            'session.save_path' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/config/routing.yml',
            ...
            'fos_facebook.options.public' => array(
                ...
                'server_url' => 'http://host/facebookApp/',
                'remember_me' => true,
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/pc-stagiaire2-symfony/Documents/bootstrapFacebook/app/cache/prod/doctrine/orm/Proxies',
