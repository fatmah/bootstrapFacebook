...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // projet_first_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'projet_first_homepage');
            }

            return array (  '_controller' => 'Projet\\FirstBundle\\Controller\\DefaultController::indexAction',  '_route' => 'projet_first_homepage',);
        }

        // projet_first_changlocal
        if (0 === strpos($pathinfo, '/loc') && preg_match('#^/loc(?:/(?P<locale>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'projet_first_changlocal')), array (  '_controller' => 'Projet\\FirstBundle\\Controller\\DefaultController::changLocalAction',  'locale' => NULL,));
        }

        // projet_first_test
        if ($pathinfo === '/test') {
            return array (  '_controller' => 'Projet\\FirstBundle\\Controller\\DefaultController::testAction',  '_route' => 'projet_first_test',);
        }
